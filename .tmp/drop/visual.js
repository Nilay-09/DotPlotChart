var DotPlotChartByOfficeSolution_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
/* harmony export */ });
/* unused harmony exports Dropdown, VisualSettings */
/* harmony import */ var powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7674);
/* harmony import */ var powerbi_visuals_utils_dataviewutils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(735);



var DataViewObjectsParser = powerbi_visuals_utils_dataviewutils__WEBPACK_IMPORTED_MODULE_1__/* .DataViewObjectsParser */ .P;
...
class DataPointCardSettings extends FormattingSettingsCard {
    ...
    slices = [this.showAllDataPoints];
}
class DataPointCardSettings2 extends FormattingSettingsCard {
    licenceValue = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.TextInput */ .z.ks({
        name: "licenceValue",
    ...
    slices = [this.licenceValue];
}
class DataPointCardSettings3 extends FormattingSettingsCard {
    circleRepresentValue = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.TextInput */ .z.ks({
        name: "circleRepresentValue",
        displayName: "Circle Represent Value",
        placeholder: "5000",
        value: ""
    });
    lableXValue = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.TextInput */ .z.ks({
        name: "lableXValue",
        displayName: "Add X Lable",
        placeholder: "",
        value: ""
    });
    lableYValue = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.TextInput */ .z.ks({
        name: "lableYValue",
    ...
    leftColor = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.ColorPicker */ .z.sk({
        name: "leftColor",
        displayName: "Color of Left Bubbles",
        value: { value: "" }
    });
    rightColor = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.ColorPicker */ .z.sk({
        name: "rightColor",
    ...
    name = "customLabel";
    displayName = "Customize Label";
    slices = [this.circleRepresentValue, this.lableXValue, this.lableYValue, this.defaultColor, this.leftColor, this.rightColor, this.fontSize];
}
...
class VisualSettings extends (/* unused pure expression or super */ null && (DataViewObjectsParser)) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   K: () => (/* binding */ TooltipHelper)
/* harmony export */ });
/* harmony import */ var powerbi_visuals_utils_tooltiputils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(477);

class TooltipHelper {
    handleTouchTimeoutId;
    visualHostTooltipService;
    rootElement;
    handleTouchDelay;
    static tooltipServiceWrapper;
    constructor(tooltipService, rootElement, handleTouchDelay) {
        this.visualHostTooltipService = tooltipService;
        this.handleTouchDelay = handleTouchDelay;
        this.rootElement = rootElement;
    }
    static renderTooltip(selection, flag) {
        // console.log("selection ",selection);
        TooltipHelper.tooltipServiceWrapper.addTooltip(selection, (datapoint) => TooltipHelper.getTooltipData(datapoint), (tooltipEvent) => tooltipEvent?.selectionId);
    }
    static getTooltipData(value) {
        var data = [];
        // debugger;
    ...
    static createTooltipWrapper(host, options) {
        TooltipHelper.tooltipServiceWrapper = (0,powerbi_visuals_utils_tooltiputils__WEBPACK_IMPORTED_MODULE_0__/* .createTooltipServiceWrapper */ .C)(host.tooltipService, options.element);
    }
}
...
/* harmony export */ });
/* harmony import */ var _tooltipHelper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(733);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(756);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6389);
/* harmony import */ var powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7674);
/* harmony import */ var powerbi_visuals_utils_tooltiputils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(477);
...
class Visual {
    ...
    valueDropdown;
    selectedIndex = 0;
    selectedRangeNumber = 50;
    selectedValueIndex = 0;
    LicenseKey = 'KhulJaaSimSim';
    constructor(options) {
        this.host = options.host;
        this.tooltipServiceWrapper = (0,powerbi_visuals_utils_tooltiputils__WEBPACK_IMPORTED_MODULE_3__/* .createTooltipServiceWrapper */ .C)(this.host.tooltipService, options.element[0]); //vishnu
        this.freeDiv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)(options.element)
            .append('div')
    ...
    `);
        this.selectorWrapper = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)(options.element)
            .append('div')
            .classed('selectorWrapper', true)
            .style('display', 'flex');
        this.legendDiv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)('.selectorWrapper')
            .append('div')
            .classed('legendDiv', true)
            .style('display', 'flex');
        this.selectorDiv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)('.selectorWrapper')
            .append('div')
            .classed('selectorDiv', true)
            .style('display', 'flex');
        this.premDiv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)(options.element)
            .append('div')
        ...
        _tooltipHelper__WEBPACK_IMPORTED_MODULE_4__/* .TooltipHelper */ .K.createTooltipWrapper(this.host, options); //vishnu
        this.tooltip = this.selectorDiv.append("div").attr("class", "toolTipBarTree").text("Hello tool tip."); //vishnu
        _tooltipHelper__WEBPACK_IMPORTED_MODULE_4__/* .TooltipHelper */ .K.renderTooltip(this.selectorDiv, 1); //vishnu
        _tooltipHelper__WEBPACK_IMPORTED_MODULE_4__/* .TooltipHelper */ .K.renderTooltip(d3__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ubm('.parentTr .valueTDCls:not(.totalTDCls):not(.totalTDPEPCls) div'), 0);
        _tooltipHelper__WEBPACK_IMPORTED_MODULE_4__/* .TooltipHelper */ .K.renderTooltip(d3__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ubm('svg.circle'), 0);
    }
    update(options) {
        ...
        if (customXLableValue !== "" && customXLableValue !== undefined) {
            d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv('.x-axis-label').text(customXLableValue);
        }
        else {
            d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv('.x-axis-label').text("X axis");
        }
        ...
        if (customYLableValue !== "" && customYLableValue !== undefined) {
            d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv('.y-axis-label').text(customYLableValue);
        }
        else {
            d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv('.y-axis-label').text("Y axis");
        }
        this.svg
            .attr('width', width)
            .attr('height', height);
        ...
        this.tooltip = this.selectorDiv.append("div").attr("class", "toolTipBarTree").text("Hello tool tip."); //vishnu
        this.tooltip = _tooltipHelper__WEBPACK_IMPORTED_MODULE_4__/* .TooltipHelper */ .K.renderTooltip(this.barContainer, 1); //vishnu
    }
    createHistogramChart(data, options) {
        // Remove existing SVG content
        d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv('.bar-container svg').remove();
        ...
        const x = d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleBand */ .WH()
            .domain(categories.map(String))
            .range([0, width])
            .padding(0.1);
        const xAxis = d3__WEBPACK_IMPORTED_MODULE_0__/* .axisBottom */ .l78(x)
            .tickFormat((domainValue) => d3__WEBPACK_IMPORTED_MODULE_0__/* .format */ .GPZ('.0f')(parseFloat(domainValue)));
        const y = d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleLinear */ .m4Y()
            .domain([0, d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B(values) || 1])
            .range([height, 0]);
        const thresholdCategory = 0.4 * d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B(categories);
        const closestCategory = categories.reduce((prev, curr) => Math.abs(curr - thresholdCategory) < Math.abs(prev - thresholdCategory) ? curr : prev);
        const svg = d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv('.bar-container')
            .append('svg')
        ...
        data.forEach((d) => {
            ...
            for (let i = 0; i < circleCount; i++) {
                ...
                svg.append('circle')
                    ...
                    .duration(800)
                    .style('opacity', 1)
                    .ease(d3__WEBPACK_IMPORTED_MODULE_0__/* .easeBounce */ .r_F);
            }
        });
        // Draw x-axis
        svg.append('g')
        ...
        svg.append('g')
            .attr('class', 'y-axis')
            .call(d3__WEBPACK_IMPORTED_MODULE_0__/* .axisLeft */ .V4s(y));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Te: () => (/* binding */ bounceOut)
/* harmony export */ });
/* unused harmony exports bounceIn, bounceInOut */
var b1 = 4 / 11,
    b2 = 6 / 11,
    b3 = 8 / 11,
    b4 = 3 / 4,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   r_: () => (/* reexport safe */ _bounce_js__WEBPACK_IMPORTED_MODULE_0__.Te)
/* harmony export */ });
/* harmony import */ var _bounce_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9067);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GPZ: () => (/* reexport safe */ d3_format__WEBPACK_IMPORTED_MODULE_4__.GP),
/* harmony export */   Ltv: () => (/* reexport safe */ d3_selection__WEBPACK_IMPORTED_MODULE_6__.Lt),
/* harmony export */   T9B: () => (/* reexport safe */ d3_array__WEBPACK_IMPORTED_MODULE_0__.T9),
/* harmony export */   Ubm: () => (/* reexport safe */ d3_selection__WEBPACK_IMPORTED_MODULE_6__.Ub),
/* harmony export */   V4s: () => (/* reexport safe */ d3_axis__WEBPACK_IMPORTED_MODULE_1__.V4),
/* harmony export */   WH: () => (/* reexport safe */ d3_scale__WEBPACK_IMPORTED_MODULE_5__.WH),
/* harmony export */   l78: () => (/* reexport safe */ d3_axis__WEBPACK_IMPORTED_MODULE_1__.l7),
/* harmony export */   m4Y: () => (/* reexport safe */ d3_scale__WEBPACK_IMPORTED_MODULE_5__.m4),
/* harmony export */   r_F: () => (/* reexport safe */ d3_ease__WEBPACK_IMPORTED_MODULE_3__.r_)
/* harmony export */ });
...
/* harmony import */ var d3_ease__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5303);
/* harmony import */ var d3_format__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4710);
/* harmony import */ var d3_scale__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1303);
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7875);
...
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9980);

var powerbiKey = "powerbi";
var powerbi = window[powerbiKey];
var DotPlotChartByOfficeSolution_DEBUG = {
    name: 'DotPlotChartByOfficeSolution_DEBUG',
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["DotPlotChartByOfficeSolution_DEBUG"] = DotPlotChartByOfficeSolution_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DotPlotChartByOfficeSolution_DEBUG);

})();

DotPlotChartByOfficeSolution_DEBUG = __webpack_exports__;
/******/ })()
;
